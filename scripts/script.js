        class Pitanje {
            ...
            jeTacan(odgovor) {
                ...
                return this.tacniOdgovovori.some(t => 
                    t.toUpperCase() === o || o.includes(t.toUpperCase())
                );
            }
        ...
        nextBtn.addEventListener('click', () => {
            ...
            if (p.tip === "radio") {
                ...
                if (izabrano && p.tacniOdgovovori.includes(izabrano.value)) tacno = true;
            } else {
                const input = document.getElementById(`textAnswer${p.id}`);
            ...
            if (trenutnoPitanje < svaPitanja.length) {
                ...
                document.querySelector('#quiz-section .container').innerHTML = `
                    <div class="text-center py-5">
                        ...
                        <p>Procenat tačnosti: ${Math.round((bodovi / svaPitanja.reduce((s,p) => s + p.poeni, 0)) * 100)}%</p>
